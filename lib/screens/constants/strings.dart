...
const automaticLogInString = 'We will log you in automatically if you have an already existing account.';
...
const bookingCancelledString = 'Your request was cancelled. Book another driver.';
const bookingAcceptedString = 'Driver has accepted your request. Go to notifications if you need to cancel.';
